...
{
	/// <summary>
	/// Propósito: Clase de acceso a datos derivada para tabla 'JornadaLaboral'.
	/// </summary>
	public class cJornadaLaboralDatos : cJornadaLaboralBase
	{
		...
		/// </summary>
		public cJornadaLaboralDatos() : base()
		{
			// Agregar código aquí.
		}
