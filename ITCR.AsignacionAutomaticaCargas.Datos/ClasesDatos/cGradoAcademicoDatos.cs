...
{
	/// <summary>
	/// Propósito: Clase de acceso a datos derivada para tabla 'gradoAcademico'.
	/// </summary>
	public class cGradoAcademicoDatos : cGradoAcademicoBase
	{
		...
		/// </summary>
		public cGradoAcademicoDatos() : base()
		{
			// Agregar código aquí.
		}
