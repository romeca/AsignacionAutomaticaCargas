...
// Descripción: Clase de LOGICA DE NEGOCIOS para tabla 'Curso'
...
{
	/// <summary>
	/// Propósito: Clase de lógica de negocios para tabla 'Curso'.
	/// </summary>
	public class cCursoNegocios : cCursoDatos
	{
		...
		/// </summary>
		public cCursoNegocios(int COD_APLICACIONBitacora, string COD_SEDEBitacora, int COD_FUNCIONALIDADBitacora, string ID_USUARIOBitacora) : base()
		{
		...
		public override bool Insertar()
		{
			...
			try
			{
				...
				operacion = "Insertar cCurso;"
					+"CodigoCurso:"+CodigoCurso.ToString()+";"
					+"NombreCurso:"+NombreCurso.ToString()+";"
					+"Fk_idGradoAcademinico:"+Fk_idGradoAcademinico.ToString()+";"
			...
			catch (Exception ex)
			{
				...
				operacion = "Error Insertar cCurso;"+ex.Message;
		...
		public override bool Actualizar()
		{
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Actualizar cCurso;"+ex.Message;
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
		...
		public override bool Eliminar()
		{
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Eliminar cCurso;"+ex.Message;
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
