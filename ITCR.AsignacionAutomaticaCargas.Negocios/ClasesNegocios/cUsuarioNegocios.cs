...
{
	/// <summary>
	/// Propósito: Clase de lógica de negocios para tabla 'Usuario'.
	/// </summary>
	public class cUsuarioNegocios : cUsuarioDatos
	{
		...
		/// </summary>
		public cUsuarioNegocios(int COD_APLICACIONBitacora, string COD_SEDEBitacora, int COD_FUNCIONALIDADBitacora, string ID_USUARIOBitacora) : base()
		{
