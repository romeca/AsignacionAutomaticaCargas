...
{
	/// <summary>
	/// Propósito: Clase de lógica de negocios para tabla 'DiasFranja'.
	/// </summary>
	public class cDiasFranjaNegocios : cDiasFranjaDatos
	{
		...
		/// </summary>
		public cDiasFranjaNegocios(int COD_APLICACIONBitacora, string COD_SEDEBitacora, int COD_FUNCIONALIDADBitacora, string ID_USUARIOBitacora) : base()
		{
