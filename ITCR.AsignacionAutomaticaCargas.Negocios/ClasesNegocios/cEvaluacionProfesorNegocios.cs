...
// Descripción: Clase de LOGICA DE NEGOCIOS para tabla 'EvaluacionProfesor'
...
{
	/// <summary>
	/// Propósito: Clase de lógica de negocios para tabla 'EvaluacionProfesor'.
	/// </summary>
	public class cEvaluacionProfesorNegocios : cEvaluacionProfesorDatos
	{
		...
		/// </summary>
		public cEvaluacionProfesorNegocios(int COD_APLICACIONBitacora, string COD_SEDEBitacora, int COD_FUNCIONALIDADBitacora, string ID_USUARIOBitacora) : base()
		{
		...
		public override bool Actualizar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Actualizar cEvaluacionProfesor;"
