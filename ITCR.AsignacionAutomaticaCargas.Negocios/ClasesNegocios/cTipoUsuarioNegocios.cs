...
{
	/// <summary>
	/// Propósito: Clase de lógica de negocios para tabla 'tipoUsuario'.
	/// </summary>
	public class cTipoUsuarioNegocios : cTipoUsuarioDatos
	{
		...
		/// </summary>
		public cTipoUsuarioNegocios(int COD_APLICACIONBitacora, string COD_SEDEBitacora, int COD_FUNCIONALIDADBitacora, string ID_USUARIOBitacora) : base()
		{
		...
		public override bool Insertar()
		{
			...
			try
			{
				...
				operacion = "Insertar cTipoUsuario;"
			...
			catch (Exception ex)
			{
				...
				operacion = "Error Insertar cTipoUsuario;"+ex.Message;
		...
		public override bool Actualizar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Actualizar cTipoUsuario;"
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Actualizar cTipoUsuario;"+ex.Message;
                //wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
