...
// Descripción: Clase de LOGICA DE NEGOCIOS para tabla 'Modalidad'
...
{
	/// <summary>
	/// Propósito: Clase de lógica de negocios para tabla 'Modalidad'.
	/// </summary>
	public class cModalidadNegocios : cModalidadDatos
	{
		...
		/// </summary>
		public cModalidadNegocios(int COD_APLICACIONBitacora, string COD_SEDEBitacora, int COD_FUNCIONALIDADBitacora, string ID_USUARIOBitacora) : base()
		{
		...
		public override bool Insertar()
		{
			...
			try
			{
				...
				operacion = "Insertar cModalidad;"
					+"CodigoModalidad:"+CodigoModalidad.ToString()+";"
			...
			catch (Exception ex)
			{
				...
				operacion = "Error Insertar cModalidad;"+ex.Message;
		...
		public override bool Actualizar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Actualizar cModalidad;"
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Actualizar cModalidad;"+ex.Message;
                //wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
		...
		public override bool Eliminar()
		{
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Eliminar cModalidad;"+ex.Message;
                //wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
