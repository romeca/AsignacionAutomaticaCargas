...
// Descripción: Clase de LOGICA DE NEGOCIOS para tabla 'TipoPrioridad'
...
{
	/// <summary>
	/// Propósito: Clase de lógica de negocios para tabla 'TipoPrioridad'.
	/// </summary>
	public class cTipoPrioridadNegocios : cTipoPrioridadDatos
	{
		...
		/// </summary>
		public cTipoPrioridadNegocios(int COD_APLICACIONBitacora, string COD_SEDEBitacora, int COD_FUNCIONALIDADBitacora, string ID_USUARIOBitacora) : base()
		{
		...
		public override bool Insertar()
		{
			...
			try
			{
				...
				operacion = "Insertar cTipoPrioridad;"
					+"TipoPrioridad:"+TipoPrioridad.ToString()+";"
			...
			catch (Exception ex)
			{
				...
				operacion = "Error Insertar cTipoPrioridad;"+ex.Message;
		...
		public override bool Actualizar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Actualizar cTipoPrioridad;"
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Actualizar cTipoPrioridad;"+ex.Message;
				wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
