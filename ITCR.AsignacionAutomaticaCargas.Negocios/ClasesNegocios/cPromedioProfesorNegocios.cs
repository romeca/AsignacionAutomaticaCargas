...
// Descripción: Clase de LOGICA DE NEGOCIOS para tabla 'PromedioProfesor'
...
// ITCR.AsignacionAutomaticaCargas.Negocios.wsSeguridad;

namespace ITCR.AsignacionAutomaticaCargas.Negocios
{
	/// <summary>
	/// Propósito: Clase de lógica de negocios para tabla 'PromedioProfesor'.
	/// </summary>
	public class cPromedioProfesorNegocios : cPromedioProfesorDatos
	{
		...
		/// </summary>
		public cPromedioProfesorNegocios(int COD_APLICACIONBitacora, string COD_SEDEBitacora, int COD_FUNCIONALIDADBitacora, string ID_USUARIOBitacora) : base()
		{
		...
		public override bool Actualizar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Actualizar cPromedioProfesor;"
					+"IdPromedio:"+IdPromedio.ToString()+";"
					+"Promedio:"+Promedio.ToString()+";"
					+"Fecha:"+Fecha.ToString()+";"
					+"Fk_idProfesor:"+Fk_idProfesor.ToString()+";"
					+"Fk_idPeriodo:"+Fk_idPeriodo.ToString()+";";
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Actualizar cPromedioProfesor;"+ex.Message;
                //wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
		...
		public override bool Eliminar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Eliminar cPromedioProfesor;"
					+"IdPromedio:"+IdPromedio.ToString()+";";
                //wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.UsoFuncionalidad, _ID_USUARIOBitacora,operacion);
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Eliminar cPromedioProfesor;"+ex.Message;
                //wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
